...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 27 2019 г., 01:21
...
(1, 'Mobile Legends: Bang Bang', 'image/logo-ml2.png', 'многопользовательская мобильная игра в жанре multiplayer online battle arena (MOBA), разработанная и изданная Shanghai Moonton Technology. Игра стала популярной в Юго-Восточной Азии.'),
(2, 'League of Legends', 'image/logo-lol.png', 'ролевая видеоигра с элементами стратегии в реальном времени (MOBA), разработанная и выпущенная компанией Riot Games 27 октября 2009 года для платформ Microsoft Windows и Apple Macintosh. Игра распространяется по модели free-to-play. Ежемесячная аудитория игры составляет 100 млн игроков по всему миру (сентябрь 2016).'),
(3, 'Defense of the Ancients', 'image/logo-dota.png', 'компьютерная многопользовательская командная игра в жанре multiplayer online battle arena, разработанная корпорацией Valve. Игра является продолжением DotA — пользовательской карты-модификации для игры Warcraft III: Reign of Chaos и дополнения к ней Warcraft III: The Frozen Throne. Игра изображает сражение на карте особого вида; в каждом матче участвуют две команды по пять игроков, управляющих «героями» — персонажами с различными наборами способностей.');
...
INSERT INTO `heroes` (`hero_id`, `hero_name`, `game_id`, `hero_image`, `hero_description`) VALUES
(1, 'Линг', '1', 'image/ling/hero.jpg', 'Late-game персонаж. Большое количество эскейпов, самое быстрое передвижение по карте и бурст урон делают его одним из самых сильных и страшных убийц.'),
(2, 'Икс.Борг', '1', 'image/xborg/hero.jpg', 'Сильный герой-боец в любой стадии игры. Он уникален своим пассивным щитом и постоянным чистым уроном.'),
(3, 'Грейнджер', '1', 'image/granger/hero.jpg', 'Стрелок, который основной урон наносит своими скиллами. А также имеет очень дальний урон с ультимативной способности.'),
(4, 'Лилия', '1', 'image/lylia/hero.jpg', 'Сильный маг с АОЕ нарастающим уроном.'),
(5, 'Рафаэль', '1', 'image/rafaela/hero.jpg', 'Хорошая поддержка в трипл мид. Имеет как хил и ускорение для союзных персонажей, так и замедление со станом для вражеских героев.'),
(6, 'Грок', '1', 'image/grock/hero.jpg', 'Танк с сильнейшим уроном в игре. Имеет и подбрасывание и анти-контроль.'),
(7, 'Windranger', '3', 'image/hero.jpg', 'герой с дальним типом атаки, основной характеристикой которого является интеллект. Она имеет четыре способности, каждая из которых является активной');
